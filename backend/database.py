...
class Player(Base):
    ...
    top_mu = Column(Float, default=1500.0)
    top_sigma = Column(Float, default=500.0)
    jungle_mu = Column(Float, default=1500.0)
    jungle_sigma = Column(Float, default=500.0)
    mid_mu = Column(Float, default=1500.0)
    mid_sigma = Column(Float, default=500.0)
    adc_mu = Column(Float, default=1500.0)
    adc_sigma = Column(Float, default=500.0)
    support_mu = Column(Float, default=1500.0)
    support_sigma = Column(Float, default=500.0)
