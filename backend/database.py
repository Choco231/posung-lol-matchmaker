...
class Player(Base):
    ...
    top_sigma = Column(Float, default=40.0)
    jungle_mu = Column(Float, default=50.0)
    jungle_sigma = Column(Float, default=40.0)
    mid_mu = Column(Float, default=50.0)
    mid_sigma = Column(Float, default=40.0)
    adc_mu = Column(Float, default=50.0)
    adc_sigma = Column(Float, default=40.0)
    support_mu = Column(Float, default=50.0)
    support_sigma = Column(Float, default=40.0)
