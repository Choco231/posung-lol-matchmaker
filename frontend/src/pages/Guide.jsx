...
export default function Guide() {
  const sections = [
    ...
    {
      title: '⚔️ 내전 결과',
      desc: '기록된 실전 경기의 양 팀 라인업과 승리 팀을 누구나 확인할 수 있는 공개 결과 페이지입니다.',
      details: [
        '가상 데이터는 포함되지 않고 실제 경기 결과만 최신순으로 표시됩니다.',
        '블루 팀과 레드 팀의 탑, 정글, 미드, 원딜, 서포터 참가자를 확인할 수 있습니다.',
        '기입자 정보는 공개 화면에 노출되지 않습니다.'
      ],
      icon: '⚔️',
      badge: '모든 사용자'
    },
